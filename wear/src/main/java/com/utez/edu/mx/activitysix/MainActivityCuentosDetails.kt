...
import com.utez.edu.mx.activitysix.databinding.ActivityMainCuentosDetailsBinding
import com.utez.edu.mx.activitysix.models.note.Note
import com.utez.edu.mx.activitysix.models.note.NoteAdapter

class MainActivityCuentosDetails : Activity() {

    private lateinit var binding: ActivityMainCuentosDetailsBinding
    lateinit var adapter: NoteAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMainCuentosDetailsBinding.inflate(layoutInflater)
